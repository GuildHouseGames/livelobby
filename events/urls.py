...
from events.views import EventListView, EventView, JoinView, JoinConfirmationView, CreateEventView, LeaveView
...
urlpatterns = [
    ...
    path('<int:pk>/leave/', LeaveView.as_view(), name='leave_view'),
